function [nbSol, qi] = solveAnalyticalIK2LinkPlanarRobot(L1, L2, x, y)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [nbSol, qi] = solveAnalyticalIK2LinkPlanarRobot(L1, L2, x, y)
% Task: solve Inverse Kinematics (if it exists) analytically for a 2-link planar robot
%
% Inputs:
...
elseif (cos_q2 > -1.0 && cos_q2 < 1.0)
	...
	q1_2 = atan2(y,x)-atan2(L2*sin(q2_2),(L1+L2*cos_q2));
